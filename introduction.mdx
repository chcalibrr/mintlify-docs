...
<CardGroup cols={2}>
  <Card
    title="Ticket Types"
    icon="comments"
    href="/ticket-handling/ticket-types"
  >
    Handling the different support ticket types
  </Card>
  <Card
    title="Analytics & Insights"
    icon="chart-area"
    href="/analytics/understanding-metrics"
  >
    Understanding the metrics and insights
  </Card>
  <Card
    title="Logs"
    icon="bars"
    href="analytics/detailed-conversation-logs"
  >
    Improve ticket handling instructions based on detailed logs
  </Card>
  <Card
    title="Support Desk"
    icon="headphones"
    href="/quickstart/connect-support-desk"
  >
    Connecting chatform to your support desk
  </Card>
  <Card
    title="Platform"
    icon="club"
    href="quickstart/connect-platform"
  >
    Give access to player data and back office integrations
  </Card>
  <Card
    title="Reasoning"
    icon="brain"
    href="/ticket-handling/context"
  >
    Make tailored reasoning decisions with personalized player data
  </Card>
</CardGroup>
